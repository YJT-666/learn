...
SimpleGUI::SimpleGUI(){
	...
	pd_cam->SetBounds(0.0, 1.0, pangolin::Attach::Pix(175), 1.0, -1024.0f / 768.0f);
...
void SimpleGUI::drawPointCloud(PointCloudTypeRGB& point_cloud, int point_size){
	glPointSize(2);
	glBegin(GL_POINTS);
	for(Eigen::Vector6d &p : point_cloud){
