...
float lastFrame = 0.0f; // the time of prvious frame
glm::vec3 cameraPos = glm::vec3(0.0f, 0.0f, 3.0f);
glm::vec3 cameraFront = glm::vec3(0.0f, 0.0f, -1.0f); // Vector pointing from the camera coordinate origin to the world coordinate origin
...
int main(){
	...
	while(!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 projection;
		projection = glm::perspective(glm::radians(fov), SCR_WIDTH / SCR_HEIGHT, 1.0f, 100.0f);
